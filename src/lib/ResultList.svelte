...
<table class="table tp">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td on:click={() => { $highlight = ($highlight == result.homeTeam ? '' : result.homeTeam) }} class="text-right" class:team-highlight={$highlight == result.homeTeam}>{result.homeTeam}</td>
            ...
            <td on:click={() => { $highlight = ($highlight == result.awayTeam ? '' : result.awayTeam) }} class="text-left" class:team-highlight={$highlight == result.awayTeam}>{result.awayTeam}</td>
        </tr>
        {/each}
    </tbody>
</table>
